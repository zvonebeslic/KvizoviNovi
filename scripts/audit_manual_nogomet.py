...
manifest=json.load(open('redo/Nogomet_source_index.json',encoding='utf-8'))
seen={}; extras=[]; files=[]
for fn in sorted(glob.glob('redo/Nogomet_*.json')):
...
Path('redo/Nogomet_manual_audit.json').write_text(json.dumps(report,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
