...
def set_wrongs(fragment, wrong1, wrong2):
    ...
    x['answers'][wrong[0]]=wrong1; x['answers'][wrong[1]]=wrong2
...
set_wrongs('veteran Drugog svjetskog rata koji ulazi u svijet organiziranog kriminala', 'Tommy Angelo', 'Lincoln Clay')
